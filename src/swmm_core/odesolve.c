...
//    Local declarations
//-----------------------------------------------------------------------------
//int      project->nmax;      // max. number of equations
//double*  project->y;         // dependent variable
//double*  project->yscal;     // scaling factors
//double*  project->yerr;      // integration errors
//double*  project->ytemp;     // temporary values of project->y
//double*  project->dydx;      // derivatives of project->y
//double*  project->ak;        // derivatives at intermediate points
...
//---------------------------------------------------------------
{
    ...
    for (nstp=1; nstp<=MAXSTP; nstp++)
    {
        ...
        for (i=0; i<n; i++)
            project->yscal[i] = fabs(project->y[i]) + fabs(project->dydx[i]*h) + TINY;
